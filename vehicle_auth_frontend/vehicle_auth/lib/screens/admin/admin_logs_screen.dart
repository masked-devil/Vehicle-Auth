...
class _AdminLogsScreenState extends State<AdminLogsScreen> {
  ...
  try {
    final response = await AdminService.getAllLogs();
                                ...
                                ...logs.map((log) {
                                  return Card(
                                    ...
                                    child: ListTile(
                                      ...
                                      title: Text(
                                        log["owner_name_associated"] != null
                                            ? "Gate Opened for ${log['category']} (Resident Name: ${log['owner_name_associated']}) at ${formatUtcTimeToReadable(log['date'], log['time'])}"
